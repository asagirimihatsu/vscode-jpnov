...
![「本の一覧」で本を展開したところ。章の一覧と、題名・ヘッダーなどの「本の情報」](docs/images/vscode-book-manage.png)
...
HTML と PDF には、ページ番号とヘッダー（ページ上部の題名）が入ります。これらは**本ごとの情報**なので、設定画面ではなく `.jpbook` の冒頭に書きます——同じフォルダーで第一巻と第二巻を作っても、ヘッダーをそれぞれ変えられます。
