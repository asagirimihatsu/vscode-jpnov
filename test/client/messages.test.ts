...
const ARGS: Record<MsgCode, readonly (string | number)[]> = {
  ...
  'path.empty': ['filelistEntry'],
  'path.rootDot': ['filelistEntry'],
  'path.homeRelative': ['filelistEntry'], // exercises the localized-label branch
  'path.absolute': ['filelistEntry'],
  'path.invalid': ['filelistEntry'],
  'path.escapesRoot': ['filelistEntry'],
